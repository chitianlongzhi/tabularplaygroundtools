...
class tabularplaygroundtools:
  def __init__(self, param):
    ...
    print('train[train.columns] = scaler.fit_transform(train[train.columns])')
    print('# Split data')
    ...
    if param['type'] == 'LSTM':
      ...
      print('X_train3 = X_train.values.reshape((X_train.shape[0], 1, X_train.shape[1]))')
      print('X_val3 = X_val.values.reshape((X_val.shape[0], 1, X_val.shape[1]))')
      print('# LSTM model')
